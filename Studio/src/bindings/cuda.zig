...
// pub const kernels = @cImport({
//     // Forward declare CUDA types as opaque types
//     // @cInclude("cuda_types.h");
...
// pub const ImageParams = kernels.ImageParams;
// // extern struct {
// //     y_plane: [*c]u8,
// //     uv_plane: [*c]u8,
// //     width: c_int,
...
// fn toCStereoParams(params: StereoParams) kernels.StereoParams {
//     return kernels.StereoParams{
...
//         .epipolar_threshold = params.epipolar_threshold,
//         .max_hamming_dist = params.max_hamming_dist,
//         .lowes_ratio = params.lowes_ratio,
//         .cost_threshold = params.cost_ratio, // note the name change
//         .epipolar_weight = params.epipolar_weight,
//         .disparity_weight = params.disparity_weight,
//         .hamming_dist_weight = params.hamming_dist_weight,
//         .show_connections = params.show_connections,
//         .disable_matching = params.disable_matching,
//     };
// }
...
//     ) !Self {
//         const id = kernels.cuda_create_detector(
//             max_keypoints,
//             gl_ytexture,
//             gl_uvtexture,
//             gl_depthtexture,
...
//         var left_pos: c_int = undefined;
//         var left_col: c_int = undefined;
//         var right_pos: c_int = undefined;
//         var right_col: c_int = undefined;

//         // Only pass non-null pointers if both position and color buffers are provided
//         const left_pos_ptr: [*c]c_int = if (left_position_buffer != null and left_color_buffer != null) blk: {
//             left_pos = @intCast(left_position_buffer.?);
//             break :blk &left_pos;
//         } else null;

//         const left_col_ptr: [*c]c_int = if (left_position_buffer != null and left_color_buffer != null) blk: {
//             left_col = @intCast(left_color_buffer.?);
//             break :blk &left_col;
//         } else null;

//         const right_pos_ptr: [*c]c_int = if (right_position_buffer != null and right_color_buffer != null) blk: {
//             right_pos = @intCast(right_position_buffer.?);
//             break :blk &right_pos;
//         } else null;

//         const right_col_ptr: [*c]c_int = if (right_position_buffer != null and right_color_buffer != null) blk: {
//             right_col = @intCast(right_color_buffer.?);
//             break :blk &right_col;
//         } else null;

//         if (kernels.cuda_register_buffers(
//             self.detector_id,
//             @intCast(keypoint_position_buffer),
//             @intCast(keypoint_color_buffer),
//             left_pos_ptr,
//             left_col_ptr,
//             right_pos_ptr,
//             right_col_ptr,
...
//         const err = kernels.cuda_map_transformation(self.detector_id, &transformation);
...
//         kernels.cuda_cleanup_detector(self.detector_id);
//     }
...
//         if (kernels.cuda_map_resources(self.detector_id) < 0) {
//             return;
//         }
//         defer kernels.cuda_unmap_resources(self.detector_id);

//         // Use GL interop path
//         const result = kernels.cuda_detect_keypoints(
//             self.detector_id,
//             toCStereoParams(params.*),
//             image,
//         );
...
//         right: *ImageParams,
//     ) !void {
//         const result = kernels.cuda_match_keypoints(
//             detector_id_left,
//             detector_id_right,
