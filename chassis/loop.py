...
- CRASH HEADROOM (2026-09-14, tempered): the binding gate is crash stress at the arm root (3x motor thrust, 16.5 MPa limit). The incumbent v163-g162b holds 14.5 MPa at 120.4 g. Over 20 generations of attacking this directly - adding root material, thickening, big section swings - all landed 17-21+ MPa: strictly worse. Stop pushing on the root. Reshape the root section ONLY at equal-or-lower total mass than the incumbent (<= 120.4 g) and only in ways that hold crash at or below the incumbent's 14.5 MPa: small section-inertia shifts (deeper-not-wider roots, fillet continuity, rib alignment), never added stock. Otherwise leave the root load path untouched and take the grams out of the shell, canopy and skin. A candidate heavier than 120.4 g or weaker than 14.5 MPa on crash is a regression, not an experiment.
