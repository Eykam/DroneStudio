...
- TOF ARRAY (hard requirement, user directive 2026-09-05): eight VL53L9CX dToF breakouts (20x16x5 mm) recess into the fuselage perimeter for 360-degree coverage - placement.json keys vl53l9cx_breakout#n/ne/e/se/s/sw/w/nw at exact 45-degree bearings, sensor face radially outward (55x42 deg FoV, 10 deg overlaps). Each mount = a shell recess seat + a small outward port (camera treatment: recessed, only the sensor face shows through the shell; PCBs must NEVER protrude - containment). A tof_hub board (25x25x6 mm) sits at deck center [0,0,0.034]. Preserve all nine placements and their mount recesses/ports in every candidate.
